...
module CreateSend
  ...
  class Person
    attr_reader :client_id, :email_address, :api_key

    def initialize(client_id, email_address, api_key = nil)
      @client_id     = client_id
    ...
    def self.get(client_id, email_address, api_key)
    ...
    def self.add(client_id, email_address, name, access_level, password, api_key)
      options = { body: {
